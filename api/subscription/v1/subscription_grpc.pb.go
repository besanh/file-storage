...
const (
	SubscriptionService_GetUserSubscription_FullMethodName   = "/api.subscription.v1.SubscriptionService/GetUserSubscription"
	SubscriptionService_SubscribePlan_FullMethodName         = "/api.subscription.v1.SubscriptionService/SubscribePlan"
	SubscriptionService_ListUserSubscriptions_FullMethodName = "/api.subscription.v1.SubscriptionService/ListUserSubscriptions"
)
...
func _SubscriptionService_SubscribePlan_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SubscriptionService_SubscribePlan_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SubscriptionServiceServer).SubscribePlan(ctx, req.(*SubscribePlanRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SubscriptionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.subscription.v1.SubscriptionService",
