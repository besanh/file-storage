...
func (x *GetUserReply) GetScope() string {
	if x != nil {
		return x.Scope
	}
	return ""
...
const file_user_v1_user_proto_rawDesc = "" +
	...
	"\n" +
	"created_at\x18\x06 \x01(\tR\tcreatedAt2Z\n" +
	"\vUserService\x12K\n" +
	"\aGetUser\x12\x17.user.v1.GetUserRequest\x1a\x15.user.v1.GetUserReply\"\x10\x82\xd3\xe4\x93\x02\n" +
	"\x12\b/v1/userB\x15Z\x13file/api/user/v1;v1b\x06proto3"
